...
google.maps.event.addDomListener(window, 'load', init);
    ...
    function init() {
        var mapOptions = {
            center: new google.maps.LatLng(46.0821795,18.2168164),
            zoom: 14,
            zoomControl: true,
            zoomControlOptions: {
        ...
        var locations = [
['Én Kicsi Éttermem', 'Pécs', '121 1212 2121', 'eke@eke.hu', 'eke.com', 46.0821795,18.2168164, 'https://mapbuildr.com/assets/img/markers/solid-pin-blue.png']
        ];
